...
public class CompatTextView extends TextView {
	...
	public CompatTextView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray style = context.obtainStyledAttributes(attrs,
				R.styleable.AppCompatTextView, defStyle, 0);
		allCaps = style.getBoolean(R.styleable.AppCompatTextView_textAllCaps,
				false);
		style.recycle();
	 ...
	 */
	private static class AllCapsTransformationMethod implements
		...
		@Override
		public void onFocusChanged(View view, CharSequence charSequence,
